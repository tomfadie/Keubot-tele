...
import re
import json
from flask import Flask, request as flask_request # TAMBAHKAN FLASK DAN request
...
if not TOKEN:
    # Log ini akan muncul jika Token tidak ada
...
# Definisi States (Sama seperti sebelumnya)
START_ROUTE, CHOOSE_CATEGORY, GET_NOMINAL, GET_DESCRIPTION, PREVIEW = range(5)

# Definisi Menu Kategori (Sama seperti sebelumnya)
KATEGORI_MASUK = {
...
# --- HANDLERS PTB (Sama seperti sebelumnya) ---
...
# --- FUNGSI UTAMA UNTUK VERCEL (MENGGUNAKAN FLASK) ---

# Inisialisasi Flask App
app = Flask(__name__)

# FUNGSI INISIALISASI APPLICATION PTB
...
# PENTING: Application instance dibuat secara global untuk Flask
application_instance = init_application()

# DEKORATOR FLASK YANG AKAN DIAMBIL VERCEL SEBAGAI ENTRY POINT
...
def flask_webhook_handler():
    ...
    try:
        # Mengambil data JSON dari Flask request
